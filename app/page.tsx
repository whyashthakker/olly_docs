...
export default function Home() {
  ...
  const mainSections = Documents.filter(
    (doc) => !("spacer" in doc) && "title" in doc,
  );
  ...
  const commonQuestions: QuestionLink[] = [
    ...
    },
    {
      ...
      docPath: "/docs/installation/connecting-llms/openai",
    },
    {
            ...
            <Card key={index} className="overflow-hidden">
              <div className="flex flex-col">
                <a
                  ...
                  onClick={() =>
                    window.open(
                      `https://docs.olly.social${item.docPath}`,
                      "_blank",
                    )
                  }
                >
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    document
                      .querySelector('[aria-label="Open Documentation Chat"]')
                      ?.dispatchEvent(

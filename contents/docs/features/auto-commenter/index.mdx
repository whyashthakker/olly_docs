...
---
![Banner](/images/olly-logo.png "Olly Auto Commenter")
...
3. You will see the download start (typically as a `dist.zip` file of approximately 9.8 MB)

![Download Page](/images/mac-install/step1.png)

### Step 2: Extract the Application
1. Locate the downloaded `dist.zip` file in your Downloads folder
2. Double-click to extract it or right-click and select "Extract"
3. A folder named "dist" will be created containing the Olly application (approximately 10 MB)

![Extracted Folder](/images/step2-extracted-folder.png)
...
![Move to Applications](/images/step3-move-to-applications.png)
...
#### If you see "olly cannot be opened because the developer cannot be verified"
...
![Security Warning](/images/step3-warning1.png)
![Privacy Settings](/images/step3-privacy-settings.png)
...
![Security Confirmation](/images/step4-warning2.png)
...
![Permissions Request](/images/step5-permissions.png)
![Quit Notice](/images/step5-quit-notice.png)
...
![Chrome Running Prompt](/images/step5-chrome-running.png)
...
![Chrome Launch](/images/step6-chrome-launch.png)
...
![Olly Extension Icon](/images/step1-extension-icon.png)
...
![Enable and Sync Toggles](/images/step2-enable-sync.png)

### Step 10: Access Settings
Click on the "Settings" gear icon on the right side of the popup.

![Settings Icon](/images/step10-settings-icon.png)
...
![Auto Commenter Settings](/images/step11-auto-commenter-settings.png)
...
![Dashboard Auto Commenter](/images/step12-dashboard.png)
...
![LinkedIn Configuration - General Tab](/images/step13-linkedin-general.png)
...
![LinkedIn Configuration - Content Tab](/images/step14-linkedin-content.png)
...
![Verify Configuration](/images/step17-verify-config.png)
...
![LinkedIn with Olly Activated](/images/step18-linkedin-activation.png)
...
![Background Operation](/images/step19-background-operation.png)
